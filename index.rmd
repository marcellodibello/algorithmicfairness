...
Th	3-5:50 PM in Tempe, [COOR](https://www.asu.edu/map/interactive/?psCode=COOR) ~~3301~~ 4401  
...
impacted people's lives and another how an algorithm has negatively impacted people's lives. The two stories need not be---and often will not be---about the same algorithm, but the same algorithm could have both positive and negative effects. 
...
[Week 1](https://www.marcellodibello.com/algorithmicfairness/handout/intro-algofairness.html) | 
[Week 2](https://www.marcellodibello.com/algorithmicfairness/handout/ProPublica-Northpointe.html) |
[Week 3](https://www.marcellodibello.com/algorithmicfairness/handout/Biased-Data.html) |
[Week 4](https://www.marcellodibello.com/algorithmicfairness/handout/Feedback-Loops.html) |
[Week 5](https://www.marcellodibello.com/algorithmicfairness/handout/Criteria.html) |
[Week 6](https://www.marcellodibello.com/algorithmicfairness/handout/impossibility.html) |
[Week 7](https://www.marcellodibello.com/algorithmicfairness/handout/history.html)  |
[Week 8](https://www.marcellodibello.com/algorithmicfairness/handout/structural.html) |
[Week 9](https://www.marcellodibello.com/algorithmicfairness/handout/structural2.html) |
[Week 10](https://www.marcellodibello.com/algorithmicfairness/handout/law.html) |
[Weeek 11](https://www.marcellodibello.com/algorithmicfairness/handout/Econ.html) |
[Weeek 12](https://www.marcellodibello.com/algorithmicfairness/handout/Equality.html) |
Week 13 - No class |
Week 14 - Workshop |
Week 15 - No class |
[Week 16](https://www.marcellodibello.com/algorithmicfairness/handout/individualized.html)  

**Additional class notes** 

- [SVM with ProPublica COMPAS Data](https://www.marcellodibello.com/algorithmicfairness/SVM-PropublicaData.html)
- [Simulating Feedback Loops in Predictive Policing](https://www.marcellodibello.com/algorithmicfairness/feedback-loop-simulation.html)
-  [Chouldechova's Impossibility: In Pictures](https://www.marcellodibello.com/algorithmicfairness/PPV.pdf)
...
- [Class notes Wk 1](https://www.marcellodibello.com/algorithmicfairness/handout/intro-algofairness.html)
...
- [Impact Evaluation of a Predictive Risk Modeling Tool for Allegheny County’s Child Welfare Office](https://www.alleghenycountyanalytics.us/wp-content/uploads/2019/05/Impact-Evaluation-from-16-ACDHS-26_PredictiveRisk_Package_050119_FINAL-6.pdf)
...
- [Class notes Wk 2](https://www.marcellodibello.com/algorithmicfairness/handout/ProPublica-Northpointe.html)
...
- ProPublica, [How We Analyzed the COMPAS Recidivism Algorithm](https://www.propublica.org/article/how-we-analyzed-the-compas-recidivism-algorithm)
    ...
    - [Exploring the ProPublica COMPAS data](https://www.marcellodibello.com/algorithmicfairness/PropublicaData.html)

- Northpointe, [Practitioner’s Guide to COMPAS Core](https://s3.documentcloud.org/documents/2840784/Practitioner-s-Guide-to-COMPAS-Core.pdf)

    - [Sample Risk Assessment COMPAS](https://s3.documentcloud.org/documents/2702103/Sample-Risk-Assessment-COMPAS-CORE.pdf)
...
- [Class notes Wk 3](https://www.marcellodibello.com/algorithmicfairness/handout/Biased-Data.html) (if interested, check out [SVM with ProPublica COMPAS Data](https://www.marcellodibello.com/algorithmicfairness/SVM-PropublicaData.html))


- Kearns and Roth, [The Ethical Algorithm](https://www.amazon.com/Ethical-Algorithm-Science-Socially-Design/dp/0190948205) - Chp. 2 (only pp. 57-64)
...
- Hart and Cooke (2013), [Another Look at the (Im-)precision of Individual Risk Estimates Made Using Actuarial Risk Assessment Instruments](https://doi.org/10.1002/bsl.2049)

    - Imrey and Dawid (2015), [A Commentary on Statistical Assessmentof Violence Recidivism Risk](https://www.tandfonline.com/doi/full/10.1080/2330443X.2015.1029338)
    
- Obermeyer et al (2019), [Dissecting Racial Bias in an Algorithm Used to Manage the Health of Populations](https://www.science.org/lookup/doi/10.1126/science.aax2342)
...
- [Class notes Wk 4](https://www.marcellodibello.com/algorithmicfairness/handout/Feedback-Loops.html) (if interested, check out my note on [Simulating Feedback Loops in Predictive Policing](https://www.marcellodibello.com/algorithmicfairness/feedback-loop-simulation.html))
...
- Brantingham et al (2018), [Does Predictive Policing Lead to Biased Arrests? Results From a Randomized Control Trial](https://www.tandfonline.com/doi/full/10.1080/2330443X.2018.1438940)
...
- [Class notes Wk 5](https://www.marcellodibello.com/algorithmicfairness/handout/Criteria.html)
...
The first part of the class will consist in 
a Q&A session with [Deborah Hellman](https://www.law.virginia.edu/faculty/profile/dh9ev/2299809), Professor of Law at 
the University of Virginia School of Law and the author of one of the readings assigned for today. 
*Please come prepared to ask questions*. 


*Key readings and materials*

- [Class notes Wk 6](https://www.marcellodibello.com/algorithmicfairness/handout/impossibility.html) (also check out [Chouldechova's Impossibility: In Pictures](https://www.marcellodibello.com/algorithmicfairness/PPV.pdf))
...
- [Class notes Wk 7](https://www.marcellodibello.com/algorithmicfairness/handout/history.html)

-  Ochigame, [The Long History of Algorithmic Fairness](https://phenomenalworld.org/analysis/long-history-algorithmic-fairness)  

-  Kiviat, [Which Data Fairly Differentiate?](https://sociologicalscience.com/articles-v8-2-26/)
...
The first part of the class will consist in 
a Q&A session with [Lily Hu](https://scholar.harvard.edu/lilyhu), a philosopher at Harvard interested 
in algorithmic bias and how the social sciences measure the causal effect of race. She is the author of some of the readings assigned for today. 
*Please come prepared to ask questions*. 

*Key readings and materials*

- [Class notes Wk 8](https://www.marcellodibello.com/algorithmicfairness/handout/structural.html)

- Hu, [What is 'Race' in Algorithmic Discrimination on the Basis of Race?](https://www.youtube.com/watch?v=m5GdAgZnpzA&list=PLdn0giYPTOk1bBDFhz047rrZ5t5I_Sju6&index=15)

- Hu, Disparate Causes, [Part I](https://phenomenalworld.org/analysis/disparate-causes-i) and [Part II](https://phenomenalworld.org/analysis/disparate-causes-pt-ii)
...
The first part of the class will consist in 
a Q&A session with [Annette Zimmermann](https://www.annette-zimmermann.com/), a 
political philosopher at the University of York working on the ethics of artificial 
intelligence and machine learning and the author of one of the readings assigned 
for today. *Please come prepared to ask questions*. 


*Key readings and materials*

- [Class notes Wk 9](https://www.marcellodibello.com/algorithmicfairness/handout/structural2.html)

- Zimmerman & Lee-Stronach, [Proceed with Caution](https://static1.squarespace.com/static/5edf7fd2ee3e960a7bd85641/t/60c4e825c714e269022fa850/1623517225765/Proceed+with+Caution+-+Annette+Zimmermann+and+Chad+Lee-Stronach+-+accepted+version+-+Canadian+Journal+of+Philosophy+2021.pdf)
...
Algorithmic fairness is closely connected with antidiscrimination 
...
- [Class notes Wk 10](https://www.marcellodibello.com/algorithmicfairness/handout/law.html)
...
- Owes, [Another Equality](https://law.yale.edu/sites/default/files/documents/faculty/papers/Fiss_AnotherEquality.pdf)
...
We now analyze the question of algorithmic 
fairness from the perspective of utilitarianism. 
Utilitarianism, roughly, says that the right action 
is one that maximizes social welfare. If utilitarianism is the correct 
ethical theory, algorithms should maximize 
social welfare and this may require to treat people unfairly. Or does it?

*Key readings and materials*

- [Class notes Wk 11](https://www.marcellodibello.com/algorithmicfairness/handout/Econ.html)
...
- [Class notes Wk 12](https://www.marcellodibello.com/algorithmicfairness/handout/Equality.html)
...
3:00 |  Filipp | *Fairness, Welfare, and Algorithms*

3:20 | Shade | *Beyond Market Logic: Algorithmic Fairness in a Social World*

3:40 | Ben | *Amnesiac Supply Chains: Database Aggregation and Algorithmic Fairness*

4:00 | Harits | *Two Constraints on Using Criminal Algorithms*

4:20 | *10 minutes break*

4:30 | Emerson | *The Highest Degree of Fairness is Not Necessarily the Most Fair* 

4:50 | Matthew | *Algorithmic Gullibility*

5:10 | Keith | *Algorithmic Judicial Ethics*

5:30 | Angela | *Algorithms and individuals*
...
In the first part of the, [Seth Lazar](http://www.sethlazar.xyz/) and Jake Stone from the Australian National University will present their ongoing project 'On the Site of Predictive Justice'
...
- [Class notes Wk 16](https://www.marcellodibello.com/algorithmicfairness/handout/individualized.html)

- Lazar and Stone, On the Site of Predictive Justice [*check Canvas for the PDF*]

- Renee Bolinger, [Algorithms and the Individual in Criminal Law](https://www.reneebolinger.com/uploads/1/0/2/6/102668958/bolinger_algorithms_and_individual_v6.pdf)
