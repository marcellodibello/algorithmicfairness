...
The question of algorithmic fairness is technical (how do algorithms work?), theoretical (what does "fairness" mean?) and practical (how do algorithms impact people's lives?). On the technical side, we will survey key concepts, such as algorithm, machine learning, supervised v. unsupervised learning, regression, classification v. clustering. This survey will be informal. Those who wish to go deeper may consult the additional materials.  On the theoretical side, we will brainstorm ideas about what we mean by "fairness" and how an algorithm could fail to be fair. We will explore several definitions of fairness later in the course. Finally, on the practical side, we will read stories about people whose lives were affected, often adversely, by algorithms. 


*Key readings and materials*

- Kearns and Roth, *The Ethical Algorithm*, Chp. 1 and Chp. 3 (only pp. 57-64)

- Eubanks, *Automating Inequality*, Chp. 4

*Additional readings and materials*

- Rogers and Mark Girolami, A First Course in Machine Learning, Chapter 1

## Week 2 - August 26 - ProPublica v. Northpointe

To understand the intricacies of the debate about algorithmic fairness, 
especially the connections between theoretical and technical questions, we will look at a well-known case study, the algorithm COMPAS which ProPublica claimed to be racially biased. [COMPAS](https://en.wikipedia.org/wiki/COMPAS_(software)) is a predictive algorithm used in criminal justice to help judges make decisions about bail, preventative detention and sentencing.
ProPublica argued that COMPAS is biased against black people. Northpointe, the company that designed COMPAS, rejected the accusation. You will see that at the core here is a disagreement about what we mean by "fairness".

In order to understand this debate, you should be familiar with a bif of probability theory. You should also be familiar with notiosn such as false positive and false negatives. We will therefore discuss a few elementary notions, in particular, the distinction between the probability of an event A given another event B, in symbols, P(A | B), and the probability of event B given event A, in symbols, P(B | A). 
...
## Week 3  - September 2 - Guided or Misguided by Data? 
...
can guide our decisions, often saving lives. For example, data have been playing a key role in the response to the COVID-19 pandemic (see, for example, Max Roser, Hannah Ritchie and Esteban Ortiz-Ospina, [Coronavirus Disease (COVID-19) - Statistics and Research](https://ourworldindata.org/coronavirus)). Another example is the data-driven Public Safety Assessment ([PSA](https://www.psapretrial.org/)) algorithm, 
...
But although data can be helpful to make decisions, they can also be biased, partial or incomplete. Biases in the data often disdavatange minorities.
...
- Caroline C. Perez, [Invisible Women: Data Bias in a World Designed for Men](https://www.amazon.com/Invisible-Women-Data-World-Designed/dp/1419729071), Chapter 8

- Cathy O'Neil, [Weapons of Math Destruction](), Chapter ??
...
## Week 4 - Septembere 9 - Feedback Loops


## Week 5 - September 16 -  The Meanings of Fairness 

What does it mean for algorithmic decisions to be fair in the first place? Computer scientists have formulated several different metrics of algorithmic fairness. By one count, there are as many as 21 definitions. Many of the definitions  of algorithmic fairness describe the extent to which *actual* rates of error are unevenly (and thus unfairly) allocated across different socially relevant groups. Scholars have also used causal modeling to formulate a *counterfactual* definition of algorithmic fairness.
...
## Week 6 - September 23- Impossibility Theorems 
...
## Week 7: Testing for discrimination 
...
## Week 8: Equal protection jurisprudence
...
## Week 11: Individualized decisions 
