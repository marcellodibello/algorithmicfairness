...
This jurisprudence focused on two main ideas: (i) limiting the use of racial classification; 
...
Any differential treatment that is due to racial animus or discriminatory intent is clearly illegal. The use of race as a factor is not automatically prohibited,  but must be justified with a clear rationale, an inquiry known as "strict scrutiny". The Supreme Court has allowed the use of race in specified contexts under strict scrutiny, for example, in college admissions for the purpose of fostering diversity.^[See [Fisher v. University of Texas at Austin](https://www.oyez.org/cases/2012/11-345), 570 U.S. 297 (2013) and [Fisher v. University of Texas at Austin](https://supreme.justia.com/cases/federal/us/579/14-981/), 579 U.S. ___ (2016).]
...
`r tufte::margin_note("The emphasis on spillover costs has the merit of broadening the discussion about algorithmic fairness beyond a narrow focus on equality metrics. Cost/benefit analysis seems to offer a principled way to think about the issue. Do you see any weakensses in Huq's argument?")`
