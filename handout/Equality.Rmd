...
them the very foundation of distributive justice.  If this is right, one question to explore is whether or not algorithms -- as they are used to guide decisions in criminal justice, health care, welfare benefits, bank loans, etc. -- reinforce or create hierarchies, even when they allocate non-punitive goods.`r tufte::margin_note("On gthis point, see Accominotti and Tadmon (2020), How the Reification of Merit Breeds Inequality: Theory and Experimental Evidence. Working Paper (42). International Inequalities Institute, London School of Economics and Political Science.")`
