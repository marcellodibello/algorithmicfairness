...
and even lower among Asians (about 35\%). Recidivism is defined as a rearrest for a criminal offense that occurred 
...
grid.arrange(pblack_s, pwhite_s, phispanic_s, ncol = 3, top=textGrob("Scores: Black, White, Hispanic", vjust= 0.4, gp=gpar(fontsize=25,font=4)))
```
...
grid.arrange(black_p_I, white_p_I, hispanic_p_I, ncol = 3, top=textGrob("Scores for reoffenders", vjust= 0.4, gp=gpar(fontsize=25,font=4)))
...
grid.arrange(black_p_G, white_p_G, hispanic_p_G, ncol = 3, top=textGrob("Scores for reoffenders", vjust= 0.4, gp=gpar(fontsize=25,font=4))) 
