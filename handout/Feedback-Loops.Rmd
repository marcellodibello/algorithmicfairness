...
```{r, echo=FALSE, fig.margin = FALSE, fig.fullwidth = FALSE, fig.cap="Deterministic proportional allocation of police resources. Police beliefs about shares of crime converge toward values relatively close to the true values of 45:55 even if prior beliefs about crime shares were initially far away from the true values.", out.width = '85%'}
